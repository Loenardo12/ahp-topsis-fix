...
return new class extends Migration
{
    ...
    {
        Schema::create('absen_kelas12', function (Blueprint $table) {
            $table->id();
            $table->foreignId('isi_kelas12_id')->constrained('isi_kelas12')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('absen_kelas12');
    }
};
