...
return new class extends Migration
{
    ...
    {
        Schema::create('absen_kelas10', function (Blueprint $table) {
            $table->id();
            $table->foreignId('isi_kelas10_id')->constrained('isi_kelas10')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('absen_kelas10');
    }
};
