                ...
                <div class="card">
                    <div class="card-body">
                        <form id="import-form" action="{{ route('import.absen.process') }}" method="POST"
                            ...
                            <!-- Hidden kelas10_id: pastikan dikirim dari controller -->
                            <input type="hidden" name="kelas10_id" value="{{ $kelas10->id ?? '' }}" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSubmitButtonState() {
                ...
                const kelasId = document.querySelector('input[name="kelas10_id"]')?.value;
