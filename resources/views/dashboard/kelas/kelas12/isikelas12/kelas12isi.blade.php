    ...
    <body>
        <div class="container">
            ...
            <div class="controls">
                ...
                <div>
                    <a href="{{ route('import.absen-kelas12.form', ['kelas12_id' => $kelas12_obj->id]) }}"
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>NISN</th>
                            @for ($i = 1; $i <= 31; $i++)
                                <!-- Diperbaiki: konsisten sampai 31 -->
                                <th>{{ $i }}</th>
                            @endfor
                            <th>Total S</th>
                            <th>Total I</th>
                        ...
                        @forelse ($absenkelas12 as $index => $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('absenkelas12.destroy', $row->id) }}" style="display:inline;"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
