                ...
                <div class="card">
                    <div class="card-body">
                        <form id="import-form" action="{{ route('import.absen-kelas12.process') }}" method="POST"
                            ...
                            <!-- Hidden kelas12_id: pastikan dikirim dari controller -->
                            <input type="hidden" name="kelas12_id" value="{{ $kelas12->id ?? '' }}" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSubmitButtonState() {
                ...
                const kelasId = document.querySelector('input[name="kelas12_id"]')?.value;
