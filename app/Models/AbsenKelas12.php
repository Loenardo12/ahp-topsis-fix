...
class AbsenKelas12 extends Model
{
    use HasFactory;

    protected $table = 'absen_kelas12';
    ...
    // Relasi: Absenkelas12 milik Isikelas12
    public function isikelas12()
    {
        return $this->belongsTo(Isikelas12::class, 'isi_kelas12_id');
    }
}
